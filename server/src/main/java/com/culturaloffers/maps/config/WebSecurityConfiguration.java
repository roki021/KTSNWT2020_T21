...
import com.culturaloffers.maps.security.auth.RestAuthenticationEntryPoint;
import com.culturaloffers.maps.security.auth.TokenAuthenticationFilter;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                // pristup slikama entiteta
                .antMatchers("/images/**").permitAll()

                .antMatchers("/offers/filtering").permitAll()
                ...
                .antMatchers(HttpMethod.GET, "/offer-types/by-page").permitAll()
                .antMatchers(HttpMethod.GET, "/offers/by-page").permitAll()
    ...
    public void configure(WebSecurity web) throws Exception {
        ...
        web.ignoring().antMatchers(HttpMethod.GET, "/g/culturaloffer/averagegrade/**");
        web.ignoring().antMatchers(HttpMethod.GET, "/c/culturaloffer/comments/**");
        web.ignoring().antMatchers(HttpMethod.GET, "/news/offer/**");
        web.ignoring().antMatchers(HttpMethod.GET, "/news/by-page/**");
